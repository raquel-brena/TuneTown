import { CreateUserAndProfileDTO, CreateUserDTO, UserResponseDTO } from "../../domain/types/User.types";
...
export class UserController implements IController {
  ...
  async createUserAndProfile(req: Request, res: Response) {
    ...
    const newUser: UserResponseDTO | null = await createUser.execute({ name, email, username, password });
